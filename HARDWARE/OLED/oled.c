...
//==============================================================
//函数名：OLED_ShowCHinese16x16(u8 x,u8 y,u8 num,u8 (*buf)[16]) num为第几个字，buf为中文数组（字体为16*16）
//功能描述：写入一组中文
...
void display(void)  //128*64显示(列,行,序号，数组名)
{	
	OLED_ShowCHinese16x16(0,0,0,LOGO); //温
	OLED_ShowCHinese16x16(16,0,1,LOGO);//度
  OLED_fuhao_write(32,1,26);//:
	OLED_ShowCHinese16x16(72,0,2,LOGO);//℃
}
